                ...
                <div class="card-body">
                    <div class="table-responsive table-data ">
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td >
                                            <div class="d-flex gap-2 justify-content-center">
                                                <a href="{{ route('admin.catalogues.show', $item) }}" class="btn btn-info btn-sm">Chi tiết 
                                                    <i class="fa-solid fa-circle-info fa-sm"></i>
                                                </a>
                                                <a href="{{ route('admin.catalogues.edit', $item) }}" class="btn btn-primary btn-sm">Chỉnh sửa 
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-center">
                                                <!-- View Button -->
                                                <a href="{{ route('admin.catalogues.show', $item) }}" class="btn btn-info btn-sm">
                                                    Chi tiết 
                                                    <i class="fa-solid fa-circle-info fa-sm"></i>
                                                </a>
                                        
                                                <!-- Edit Button -->
                                                <a href="{{ route('admin.catalogues.edit', $item) }}" class="btn btn-primary btn-sm">
                                                    Chỉnh sửa 
                                                    <i class="fa-regular fa-pen-to-square fa-sm"></i>
                                                </a>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mt-2 text-center">
                                                                ...
                                                                <div class="mt-4 pt-2 fs-15 mx-sm-5">
                                                                    ...
                                                                    <p class="text-muted mx-4 mb-0">Bạn muốn xoá catalogue này?</p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Đóng</button>
                                                                <form id="delete-form{{ $item->id }}" action="{{ route('admin.catalogues.destroy', $item) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                <p>Hiển thị từ {{ $listCatalogue->firstItem() }} đến {{ $listCatalogue->lastItem() }} trong tổng số {{ $listCatalogue->total() }} danh mục</p>
                            </div>
                            <div>
                                {{ $listCatalogue->links() }}
                            </div>
