                    ...
                    <script>
                        document.querySelectorAll('button[data-period]').forEach(button => {
                            button.addEventListener('click', function () {
                                ...
                                fetch(`/admin/earnings?period=${period}`, {
                                    method: 'GET',
                                    headers: {
                        ...
                        $('button[data-period]').on('click', function () {
                            ...
                            $.ajax({
                                url: `/admin/earnings?period=${period}`,
                                method: 'GET',
                                success: function (data) {
                                    $('h4 span').text(`${data.total_earnings.toLocaleString()} VND`);
                                },
    ...
    <script>
        ...
        function changePageCustomer(page) {
            ...
            for (var i = (page - 1) * records_per_page; i < (page * records_per_page) && i < topCustomers.length; i++) {
                ...
                var total = customer.total_spent ? new Intl.NumberFormat('vi-VN').format(customer.total_spent) + " VND" : "0 VND";
                ...
                <tr>
                    ...
                    <td>
                        <h5 class="fs-14 my-1 fw-normal">${total}</h5>
