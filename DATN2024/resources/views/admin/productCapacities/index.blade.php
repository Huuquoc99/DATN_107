                            ...
                            <tbody id="product-list">
                                @foreach($listProductCapacity as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>
                                            <a href="{{ route('admin.productCapacities.edit', $item) }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{ $item->name }}">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-center">
                                                <a href="{{ route('admin.productCapacities.edit', $item) }}" class="btn btn-primary btn-sm">
                                                    Chỉnh sửa 
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mt-2 text-center">
                                                                ...
                                                                <div class="mt-4 pt-2 fs-15 mx-sm-5">
                                                                    <h4>Are you sure?</h4>
                                                                    <p class="text-muted mx-4 mb-0">Do you want to delete this product capacity?</p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                                                                <form id="delete-form{{ $item->id }}" action="{{ route('admin.productCapacities.destroy', $item) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
