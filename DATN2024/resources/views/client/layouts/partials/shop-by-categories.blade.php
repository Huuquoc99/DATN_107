                ...
                <div class="col text-center d-flex flex-column align-items-center" style="width: 220px;">
                    <a href="{{ route('shop', array_merge(request()->except('c'), request()->get('c') == $catalogue->id ? [] : ['c' => $catalogue->id])) }}"
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 100px; height: 100px; border-radius: 50%; border: 2px solid #ccc; overflow: hidden; position: relative;">
                        ...
                        <p class="menu-link menu-link_us-s fw-semi-bold fs-15 theme-color text-uppercase mt-2">
                            {{ $catalogue->name }}</p>
                    </a>
                </div>
            @endforeach
