                        ...
                        <tr>
                            <td style="padding: 0 2.5em; text-align: left;">
                                <div class="text">
                                    ...
                                    <h3>Have a great day! And have a good experience in the store!</h3>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                        <th width="80%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Product</th>
                        <th width="20%" style="text-align:right; padding: 0 2.5em; color: #000; padding-bottom: 20px">Quantity</th>
                    ...
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                        <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                            <div class="product-entry">
                                <h4>Name: {{ $customer_name }}</h4>
                                <h4>Phone: {{ $customer_phone }}</h4>
                                <h4>Email: {{ $customer_email }}</h4>
                                <h4>Address: {{ $customer_address }}</h4>
                                <h4>Payment method: {{ $payment_method_id == 1 ? 'COD' : 'VNPay' }}</h4>

                            </div>
                        </td>
                    </tr>
                    <div class="bg_white m3" style="text-align: end; ">
