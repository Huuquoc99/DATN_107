...
<body style="font-family: Arial, sans-serif; color: #333; background-color: #f9f9f9; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
        <h2 style="color: #4CAF50; font-size: 24px; text-align: center;">Thank you for ordering at TechStore!</h2>
        ...
        <div style="text-align: center; margin-top: 30px;">
            <p style="font-size: 14px; color: #777;">Thank you for shopping at TechStore!</p>
            <p style="font-size: 14px; color: #777;">If you have any questions, please contact us via email: <a href="mailto:techstore@gmail.com" style="color: #4CAF50;">techstore@gmail.com</a></p>
        </div>
    </div>
</body>
</html>
