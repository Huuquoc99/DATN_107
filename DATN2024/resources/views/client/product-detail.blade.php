        ...
        <div class="col-lg-7">
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0.jpg')}}" width="674" height="674" alt="">
                    <a data-fancybox="gallery" href="{{asset('theme/client/images/products/product_0.jpg')}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_zoom" /></svg>
                    </a>
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0-1.jpg')}}" width="674" height="674" alt="">
                    <a data-fancybox="gallery" href="{{asset('theme/client/images/products/product_0-1.jpg')}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_zoom" /></svg>
                    </a>
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0-2.jpg')}}" width="674" height="674" alt="">
                    <a data-fancybox="gallery" href="{{asset('theme/client/images/products/product_0-2.jpg')}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_zoom" /></svg>
                    </a>
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0-3.jpg')}}" width="674" height="674" alt="">
                    <a data-fancybox="gallery" href="{{asset('theme/client/images/products/product_0-3.jpg')}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_zoom" /></svg>
                    </a>
                  </div>
                </div>
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0.jpg" ')}}width="104" height="104" alt=""></div>
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0-1.jpg')}}" width="104" height="104" alt=""></div>
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0-2.jpg')}}" width="104" height="104" alt=""></div>
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('theme/client/images/products/product_0-3.jpg')}}" width="104" height="104" alt=""></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img loading="lazy" src="{{asset('theme/client/images/products/product_3.jpg')}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{asset('theme/client/images/products/product_3-1.jpg')}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
