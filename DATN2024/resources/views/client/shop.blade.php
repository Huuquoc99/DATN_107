                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <select id="price-filter" class="d-none" multiple name="price-list">
                                    ...
                                    <option value="5" {{ in_array('5', $selectedPrices) ? 'selected' : '' }}>10 đến
                                        15
                                        triệu
                                    </option>
                                    <option value="6" {{ in_array('6', $selectedPrices) ? 'selected' : '' }}>15 đến
                                        20
                                        triệu
                                    </option>
                                    <option value="7" {{ in_array('7', $selectedPrices) ? 'selected' : '' }}>20 đến
                                        30
                                        triệu
                                    </option>
            ...
            <div class="shop-list flex-grow-1">
                <div class="d-flex justify-content-between mb-4 pb-md-2 ">
                    <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1" style="margin-top: -25px;">
                        <a href="{{ route('home') }}" class="menu-link menu-link_us-s text-uppercase fw-medium"
